...
let ui = {
    ...
    initRangeBox() {
        ...
        conf.range.min = Math.min(...conf.range.idList, 0);
        conf.range.max = Math.max(...conf.range.idList, 0);
    ...
    onProjectChange() {
        ...
        $preview.src = `media/material/${conf.info.theme}.png`;
        $preview.alt = $preview.src;
