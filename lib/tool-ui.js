...
let $basket = document.getElementById("basket"),
    ...
    $ignoreConfMaxid = document.getElementById("ignoreConfMaxid");
...
let ui = {
    ...
    useCustomId: () => $ignoreConfMaxid.checked,
    ...
    onProjectChange() {
        ...
        conf.info.language = conf.info.lesson.match(/chinese/i) ? "chinese" : "english";
    ...
    /*********************/
    activeEditTool(e) {
        if (e.target.className.match(/chinese|english/) && !conf.editTool.locker) {
            let rect = e.target.getBoundingClientRect();
            conf.editTool.dom = e.target;
            conf.editTool.id = e.target.closest("tr").dataset.id;
            conf.editTool.language = e.target.className;
    ...
    updateServerStatus(is_ok) {
        $server.className = is_ok ? "ok" : "error";
    },
