...
let ui = {
    ...
    switchEditTool() {
        $doEditCell.style.display = conf.edit.locker ? "none" : "block";
        $doGenAudioPiece.style.display = conf.edit.locker ? "none" : "block";
        $doEditDone.style.display = conf.edit.locker ? "block" : "none";
        $doEditRestore.style.display = conf.edit.locker ? "block" : "none";
    },
