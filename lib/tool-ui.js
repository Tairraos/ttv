...
let ui = {
    ...
    /*********************/
    enableGenVideoBtn() {
        document.getElementById("doBuild").innerHTML = "6.生成作品";
    },
    ...
    updateServerStatus(isOk) {
        document.getElementById("server").className = isOk ? "ok" : "error";
    },
...
document.getElementById("doGenAudioPiece").addEventListener("click", action.doGenAudioPiece, false); // 浮动菜单的 audio
