...
let util = {
    ...
    formatProjectId: function (projectId) {
        return (+projectId).toString().padStart(4, "0");
    },

    getTheme: function (projectId, lesson) {
        return conf.lesson[lesson].abbr + util.formatProjectId(projectId);
    },
