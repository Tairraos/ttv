...
let action = {
    ...
    genNoimgSlide: async function () {
        ...
        await util.fetchApi("api/slide", { filename: `${conf.info.theme}.png`, theme: conf.info.theme, lesson: util.getLesson() });
    ...
    getProgram: function (lesson, type) {
        let rules = {
            chinese: {
                sentence: ["ding,0", "cn_female,0", "cn_male,0", "cn_female,1", "cn_male,1", "en_female,2"],
                word: ["cn_female,1", "cn_male,1", "en_female,2"]
            },
            english: {
                sentence: ["ding,0", "en_female,0", "en_male,0", "en_female,1", "en_male,1", "cn_female,2"],
