...
// UI显示的字段名
conf.uiFields = ["id", "type", "group", "voice", "chinese", "english", "phonetic", "comment", "theme", "media_cn1", "media_cn2", "media_en1", "media_en2", "slide", "action"];
// 实际导入导出需要的data字段
conf.dataFields = ["id", "type", "group", "voice", "chinese", "english", "phonetic", "comment", "theme"];
// 导出时标题栏对应的名字
conf.exportTitles = ["id", "类型", "分组", "音色", "中文", "英文", "音标或拼音", "注释", "主题"];
// 导出时每列的宽度
conf.exportWidth = [50, 70, 50, 70, 350, 350, 350, 150, 80];
