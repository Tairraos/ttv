...
let dict = {
    e2c: null //简明英汉字典，用于给英文单词标注音标和翻译
};

let setup = {
    // 实际导入导出需要的data字段
    dataFields: ["id", "sid", "type", "group", "voice", "chinese", "english", "phonetic", "comment", "theme"],
    sheet: {
        book: {
...
// UI显示的字段名
setup.uiFields = setup.dataFields.concat(["media_cn1", "media_cn2", "media_en1", "media_en2", "slide", "action"]);
